...
2.  **PascalCase Convention**: ëª¨ë“  ì»´í¬?ŒíŠ¸ ?´ë”?€ ?Œì¼ëª…ì? **PascalCase**ë¥??¬ìš©?©ë‹ˆ??
3.  **Hybrid Component Pattern**: `ComponentName/ComponentName.tsx` + `ComponentName.module.scss` + `index.ts` êµ¬ì¡°ë¥??°ë¦…?ˆë‹¤.
4.  **Server Components First**: ëª¨ë“  ?°ì´???˜ì¹­?€ ?œë²„ ì»´í¬?ŒíŠ¸?ì„œ ?˜í–‰?˜ë©°, ?´ë¼?´ì–¸???¬ì´???˜ì¹­?€ ì§€?‘í•©?ˆë‹¤.
5.  **Mobile First**: ëª¨ë“  ?”ì?¸ê³¼ ?¸í„°?™ì…˜?€ ëª¨ë°”???˜ê²½(Portrait)??ìµœì ?”í•©?ˆë‹¤.
