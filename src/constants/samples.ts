...
export const GREETING_SAMPLES: SamplePhraseItem[] = [
    ...
    },
    {
        subtitle: 'True Love',
        title: '사랑의 결실',
        content: '<p>서로 다른 색으로 물들어 온 두 사람이<br>이제는 하나의 빛으로 어우러지려 합니다.</p><p>서로를 이해하고 아껴주는 마음으로<br>아름다운 세상을 만들어 가겠습니다.<br>귀한 걸음 하시어 축복해 주시면 더없는 기쁨이겠습니다.</p>'
    },
    {
        subtitle: 'Happy Together',
        title: '아름다운 동행',
        content: '<p>오랜 시간 친구로 지내며 쌓아온 우정이<br>이제 사랑이라는 이름으로 결실을 맺습니다.</p><p>같은 곳을 바라보며 걸어갈 저희의 첫걸음에<br>따뜻한 사랑과 응원을 보내주세요.</p>'
    },
    {
        subtitle: 'New Beginning',
        title: '시작하는 마음',
        content: '<p>작은 인연이 닿아 연인이 되었고<br>이제는 평생의 반려자가 되려 합니다.</p><p>서로의 부족함을 채워주고 기쁨은 나누며<br>행복하게 살겠습니다.<br>저희의 약속을 지켜봐 주시고 응원해 주세요.</p>'
    },
    {
        subtitle: 'Beautiful Day',
        title: '꽃피는 날',
        content: '<p>계절의 포근함 속에서<br>저희 두 사람 사랑의 서약을 맺습니다.</p><p>서로에게 든든한 나무가 되어주고<br>때로는 시원한 그늘이 되어주며 살겠습니다.<br>이 아름다운 시작에 증인이 되어주세요.</p>'
    },
    {
        subtitle: 'Promise',
        title: '평생의 약속',
        content: '<p>서로가 서로에게 가장 소중한 선물이 되어<br>평생을 아끼고 사랑하며 살겠습니다.</p><p>진실된 마음으로 맺는 이 약속의 자리에<br>소중한 분들을 모십니다.</p>'
    },
    {
        subtitle: 'First Love',
        title: '첫 마음 그대로',
        content: '<p>첫 만남의 설렘을 기억하며<br>매 순간을 소중히 여기겠습니다.</p><p>때로는 친구처럼, 때로는 연인처럼<br>서로의 곁을 지키며 살아가겠습니다.<br>저희의 행복한 동행을 축복해 주세요.</p>'
    },
    {
        subtitle: 'Wedding Vow',
        title: '사랑의 서약',
        content: '<p>두 사람이 하나 되어 걷는 이 길에<br>사랑과 믿음만이 가득하기를 소망합니다.</p><p>기쁠 때나 슬플 때나<br>서로의 손을 놓지 않고 함께하겠습니다.<br>그 약속의 시간에 함께 해주시면 감사하겠습니다.</p>'
    }
];
