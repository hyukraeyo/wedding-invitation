  ...
  return (
    <main className="flex h-screen w-full bg-gray-100 overflow-hidden">
      ...
      <section className="w-[400px] lg:w-[480px] h-full border-r border-gray-200 bg-white shadow-xl z-10 flex flex-col">
        <div className="p-6 border-b border-gray-100 bg-ivory/30 flex items-center justify-between">
          <div>
            <h1 className="font-serif text-2xl text-forest-green font-bold tracking-tight">
              Wedding Invitation
            </h1>
            <p className="text-sm text-gray-500 mt-1">Mobile Builder</p>
          </div>
          <button
            onClick={() => setIsLoginModalOpen(true)}
            className="flex items-center gap-2 bg-forest-green text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-forest-green/90 transition-colors shadow-sm"
          >
            <Save size={16} />
            <span>저장</span>
          </button>
