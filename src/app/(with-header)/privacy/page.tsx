    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <p className={styles.lead}>
          &apos;바나나웨딩&apos;(이하 &apos;서비스&apos;)은 정보주체의 자유와 권리 보호를 위해
          「개인정보 보호법」 및 관계 법령이 정한 바를 준수하며, 이용자의 개인정보를 안전하게
          처리하고 보호하기 위해 다음과 같은 처리방침을 수립·공개합니다.
        </p>

        <h3 className={styles.sectionTitle}>1. 개인정보의 수집 및 이용 목적</h3>
        <p>
          서비스는 다음의 목적을 위해 최소한의 개인정보를 처리합니다. 처리하고 있는 개인정보는
        ...
        <ul className={styles.list}>
          ...
          <li>
            ...
            고충 처리 등 원활한 서비스 운영을 위해 활용됩니다.
          </li>
        </ul>

        <h3 className={styles.sectionTitle}>2. 수집하는 개인정보의 항목</h3>
        ...
        <ul className={styles.list}>
          ...
          <li>
            <strong>예외 보관:</strong> 서비스 부정이용 기록이 있는 경우, 재가입 제한 및 부정 이용
            방지를 위해 탈퇴 후 1년간 해당 항목(식별값, 휴대폰 번호)을 암호화하여 보관합니다.
          </li>
        </ul>

        <h3 className={styles.sectionTitle}>4. 정보주체의 권리 및 행사방법</h3>
        ...
        <p className={styles.smallNote}>
          권리 행사는 마이페이지 내 정보 수정 또는 고객센터(이메일)를 통해 서면이나 전자우편으로
          신청하실 수 있으며, 서비스는 이에 대해 지체 없이 조치하겠습니다.
        </p>

        <h3 className={styles.sectionTitle}>5. 개인정보의 안전성 확보 조치</h3>
        <p>서비스는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.</p>
        <ul className={styles.list}>
          <li>
            <strong>기술적 조치:</strong> 개인정보의 암호화 저장, 보안 프로그램 설치 및 주기적
            업데이트
          </li>
          <li>
            <strong>관리적 조치:</strong> 개인정보 접근 권한 최소화 및 정기적인 보안 교육
          </li>
        </ul>

        <h3 className={styles.sectionTitle}>6. 개인정보 보호책임자</h3>
        <p>
          개인정보 처리에 관한 업무를 총괄해서 책임지고, 이용자의 불만처리 및 피해구제 등을 위하여
          아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
        </p>
        <div className={styles.noteBox}>
          <p>
            <strong>바나나웨딩 운영팀</strong>
          </p>
