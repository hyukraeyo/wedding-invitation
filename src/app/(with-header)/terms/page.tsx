    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <ul className={styles.list}>
          ...
          <li>
            서비스는 관계 법령을 위반하지 않는 범위 내에서 약관을 개정할 수 있으며, 변경 시
            적용일자와 변경 사유를 사전에 공지합니다.
          </li>
        </ul>
        ...
        <ul className={styles.list}>
          ...
          <li>
            서비스는 법령 위반, 권리 침해, 서비스 운영 방해에 해당하는 콘텐츠를 사전 통지 후 또는
            긴급 시 사후 통지로 제한할 수 있습니다.
          </li>
        </ul>
        ...
        <ul className={styles.list}>
          <li>
            서비스는 천재지변, 불가항력, 이용자 귀책사유로 인한 손해에 대해 책임을 지지 않습니다.
          </li>
          <li>
            이용자 간 또는 이용자와 제3자 간 분쟁에 대해 서비스는 법령상 책임 범위 내에서만
            대응합니다.
          </li>
        </ul>
